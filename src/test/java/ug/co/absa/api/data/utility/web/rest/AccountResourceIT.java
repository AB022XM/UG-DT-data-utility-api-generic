package ug.co.absa.api.data.utility.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
import static ug.co.absa.api.data.utility.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import ug.co.absa.api.data.utility.IntegrationTest;
import ug.co.absa.api.data.utility.config.Constants;
import ug.co.absa.api.data.utility.domain.User;
import ug.co.absa.api.data.utility.repository.AuthorityRepository;
import ug.co.absa.api.data.utility.repository.UserRepository;
import ug.co.absa.api.data.utility.security.AuthoritiesConstants;
import ug.co.absa.api.data.utility.service.UserService;
import ug.co.absa.api.data.utility.service.dto.AdminUserDTO;
import ug.co.absa.api.data.utility.service.dto.PasswordChangeDTO;
import ug.co.absa.api.data.utility.service.dto.UserDTO;
import ug.co.absa.api.data.utility.web.rest.vm.KeyAndPasswordVM;
import ug.co.absa.api.data.utility.web.rest.vm.ManagedUserVM;
