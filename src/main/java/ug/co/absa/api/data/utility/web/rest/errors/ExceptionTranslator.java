package ug.co.absa.api.data.utility.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.api.data.utility.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.api.data.utility.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.api.data.utility.service.InvalidPasswordException
